...
static inline protocol_exception<Error::NotImplemented> CreateErrorNotImplemented() { auto err = Error::NotImplemented();  return protocol_exception<decltype(err)>(err); }
